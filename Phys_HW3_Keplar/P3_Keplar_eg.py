...
mars = as_obj(pos = vector(d_at_perihelion['mars'], 0, 0), radius = 1.5E10, m = mass['mars'], color = color.red, make_trail = True)
mars.v = vector(0, 0, -v_at_perihelion['mars'])

halley = as_obj(pos = vector(d_at_perihelion['halley'], 0, 0), radius = 1.5E10, m = mass['halley'], make_trail = True)
